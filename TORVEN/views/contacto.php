...
<div style="display:grid;grid-template-columns:1fr 320px;gap:32px;padding:32px 64px 0;">
  ...
  <div style="display:flex;flex-direction:column;gap:12px;">
    ...
    <div style="display:flex;gap:12px;">
      ...
      <a href="https://instagram.com/torventaller" target="_blank" style="flex:1;display:flex;align-items:center;justify-content:center;gap:8px;padding:12px;border-radius:6px;background:linear-gradient(135deg,#f09433,#e6683c,#cc2366);color:#fff;font-size:13px;font-weight:700;text-decoration:none;">
